    ...
    <ul class="navbar-nav ml-auto">
      ...
      <li class="nav-item dropdown no-arrow">
        <a class="nav-link dropdown-toggle" href="#" id="userDropdown" role="button" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
          <span class="mr-2 d-none d-lg-inline text-gray-600 small text-capitalize">  <?php echo $_SESSION['Admin'] ?></span>
    ...
    <!-- End of Sidebar -->
        ...
        <div class="container-fluid">
          ...
          <div class="d-sm-flex align-items-center justify-content-between mb-4">
            <h1 class="h3 mb-0 text-gray-800 capital">Dashboard</h1>
          </div>
          ...
          <div class="row">
            ...
            <div class="col  mb-4">
              <!-- Illustrations -->
              <h3 class="text-center" style="font-family: Visually;">Dashboard of GITSHOP Store</h3>
              <div class="container">
              <div class="row d-flex justify-content-center">
                <img width="50%" src="img/mark.svg" alt="">
              </div>
              </div>
                  ...
                  <a  href="category/">
                    <div class="card-body">
                      <div class="row no-gutters align-items-center">
                        <div class="col mr-2">
                          <div class="text-xs font-weight-bold text-white text-uppercase mb-1"> categories</div>
                          <div class="h5 mb-0 font-weight-bold text-white"><?php echo $count_category ?></div>
                        </div>
                        <div class="col-auto">
                    ...
                    <div class="card-body">
                      <div class="row no-gutters align-items-center">
                        <div class="col mr-2">
                          ...
                          <div class="h5 mb-0 font-weight-bold text-white"><?php echo $count_product ?></div>
                        </div>
                        <div class="col-auto">
                    ...
                    <div class="card-body">
                      <div class="row no-gutters align-items-center">
                        <div class="col mr-2">
                          ...
                          <div class="h5 mb-0 font-weight-bold text-dark"><?php echo $count_users ?></div>
                        </div>
                        <div class="col-auto">
                    ...
                    <div class="card-body">
                      <div class="row no-gutters align-items-center">
                        <div class="col mr-2">
                          ...
                          <div class="h5 mb-0 font-weight-bold text-white"><?php echo $count_orders ?></div>
                        </div>
                        <div class="col-auto">
