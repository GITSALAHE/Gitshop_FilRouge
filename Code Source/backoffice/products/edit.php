...
<body id="page-top">
    ...
    <div id="wrapper">
        ...
        <div id="content-wrapper" class="d-flex flex-column">
            ...
            <div class="form-group">
                <button class="btn btn-maria" type="button" onclick="infile()">
            ...
            <div class="form-group">
                <button class="btn btn-maria" type="button" onclick="infile1()">
            ...
            <button name="editProduct" type="submit" class="btn btn-maria">Submit</button>
                            </form>
                        </div>
                    </div>
                </div>
