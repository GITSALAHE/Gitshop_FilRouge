    ...
    <div id="wrapper">
        ...
        <div id="content-wrapper" class="d-flex flex-column">
          ...
          <div class="form-group">
              ...
              <input id="my-input" class="form-control form-control-user" type="text" name="fullname">
          </div>
          <div class="form-group">
              <label for="my-input">email</label>
              <input id="my-input" class="form-control form-control-user" type="email" name="email">
          </div>
          <div class="form-group">
              <label for="my-input">password</label>
              <input id="my-input" class="form-control form-control-user" type="password" name="password">
          </div>
          <div class="form-group">
              <label for="my-input">phone number</label>
              <input id="my-input" class="form-control form-control-user" type="tel" name="phone_number" placeholder="06XXXXXXXX" pattern="[0-9]{10}" required>
          </div>
          <div class="form-group">
          ...
          <button type="submit" name="registerBackoffice" class="btn btn-maria btn-user btn-block">Submit</button>
      </form> 
                            </div>
                            </div>
