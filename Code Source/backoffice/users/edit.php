        ...
        <div id="content-wrapper" class="d-flex flex-column">
            ...
            Profil
                ...
                <div class="container-fluid">
                    ...
                    <a name="" id="" class="btn btn-maria mb-2" href="create.php" role="button">Add user or admin</a>
                    <?php include('../../app/helpers/flashmessage.php') ?>
                    <div class="card shadow mb-4">

                        <div class="card-header py-3">
                            <h6 class="m-0 font-weight-bold text-primary">Add users or Admins</h6>
                        </div>
                        <div class="card-body">
                            <div class="col">
                            <div class="p-5">
                            <h1 class="text-center">Edit user : <?php echo "'$fullnameEdit'"?> </h1>
                            <form action="" class="user" method="post">
                            <input type="hidden" name="idU" value="<?php echo $idUedit ?>">
          
          <div class="form-group">
              <label for="my-input">full name</label>
              <input id="my-input" class="form-control form-control-user" value="<?php echo $fullnameEdit ?>"  type="text" name="fullname">
          </div>
          <div class="form-group">
              <label for="my-input">email</label>
              <input id="my-input" class="form-control form-control-user" value="<?php echo $emailEdit ?>" type="email" name="email">
          </div>
        
          <div class="form-group">
              <label for="my-input">phone number</label>
              <input id="my-input" class="form-control form-control-user" value="<?php echo $phoneEdit; ?>" type="tel" name="phone_number" placeholder="06XXXXXXXX" pattern="[0-9]{10}" required>
          </div>
          <div class="form-group">
          ...
          <?php if($status == 1): ?>
                      ...
                      <input type="checkbox" name="admin" class="custom-control-input" id="customCheck" checked>
                      <label class="custom-control-label" for="customCheck">Admin ?</label>
                   <?php else: ?>
                    <input type="checkbox" name="admin" class="custom-control-input" id="customCheck" >
                      <label class="custom-control-label" for="customCheck">Admin ?</label>
                    <?php endif; ?>
          ...
          <button type="submit" name="editUserBackoffice" class="btn btn-maria btn-user btn-block">Submit</button>
      </form> 
                            </div>
                            </div>
