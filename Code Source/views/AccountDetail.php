		...
		<div class="container">
			<div class="row">
				...
				<div class="col-lg-6">
						...
						<div class="checkout_form_container">
							...
							<input type="hidden" name="idU" value="<?php echo $dataUserToEdit['idU'] ?>">
								...
								<div>
									...
									<input name="fullname" value="<?php echo $dataUserToEdit['fullname'] ?>" type="text" id="checkout_Name" class="checkout_input">
								</div>
								<div>
									<!-- Email -->
									<label for="checkout_email">Email Address*</label>
									<input type="email" value="<?php echo $dataUserToEdit['email'] ?>" name="email" id="checkout_email" class="checkout_input">
								</div>
								<div>
									<div class="row">
										<div class="col-xl-6">
											...
											<input type="password" name="password" id="checkout_Pass"
												class="checkout_input">
										</div>
										<div class="col-xl-6 last_name_col">
											<!-- Confirm New Password -->
											<label for="checkout_New_Pass">Confirm New Password*</label>
											<input name="passwordConf" type="password" id="checkout_New_Pass"
												class="checkout_input">
										</div>
									</div>
									<div>
										...
										<input name="phone_number" value="<?php echo $dataUserToEdit['phone_number'] ?>" type="text" id="checkout_Phone" class="checkout_input">
									</div>
								</div>
								<div>
								</div>
					...
					<button id="checkout" class="button" name="editCustomer" type="submit">Save Changes</button>
					</form>
				</div>
			</div>
		</div>
