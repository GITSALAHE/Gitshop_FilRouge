                ...
                <div class="col-lg-6">
                    ...
                    <div class="billing checkout_section">
                        ...
                        <div class="checkout_form_container">
                            <form method="post"  id="payment-form" class="checkout_form">
                                ...
                                <div>
                                    <!-- Zipcode -->
                                    <label for="checkout_phone">Zipcode*</label>
                                    <input type="text" name="zip" placeholder="ex: 40000" id="checkout_phone" class="checkout_input" required="required">
                                </div>
                                <div>
                                    <!-- Zipcode -->
                                    <label for="checkout_zipcode">Phone number*</label>
                                    <input type="text" name="phone_number" placeholder="06 XX XX XX XX" id="checkout_zipcode" class="checkout_input" required="required">
                                </div>
                                <div>
                                    <!-- Province -->
                                    <label for="checkout_province">Province*</label>
                                    <input type="hidden" name="country" id="countryId" value="MA" />
                                    <select id="stateId" name="state" class="dropdown_item_select checkout_input states order-alpha" require="required">
                                ...
                                <div>
                                    ...
                                    <select id="cityId" name="city" class="dropdown_item_select checkout_input cities order-alpha" require="required">
                                    ...
                                    <div class="payment">
                                        <div class="payment_options">
                                            ...
                                            <label class="payment_option clearfix">Credit/Debit card
                                                <input name="stripe" type="radio" name="radio" checked>
                                ...
                                ?>
                                    <li class="d-flex flex-row align-items-center justify-content-start">
                                        <div class="order_list_title">
                                            <?php echo $nameProduct['nameProduct'] . ' X ' . $pcart['qte'] ?></div>
                                        <div class="order_list_value ml-auto">
                                            <?php echo $nameProduct['Price'] * $pcart['qte'] ?></div>
                                    </li>
                                <?php endforeach; ?>
