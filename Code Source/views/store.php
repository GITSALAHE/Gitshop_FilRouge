        ...
        <form method="POST">
          <div class="row mb-4">
            <div class="form-group col-md-9">
              <input id="exampleFormControlInput5" type="text" name="search" placeholder="What're you searching for?" class="form-control form-control-underlined">
            </div>
            <div class="form-group col-md-3">
              <button type="submit" style="background-color:#8167A9;border: none;" class="btn btn-primary rounded-pill btn-block shadow-sm">Search</button>
            </div>
          </div>
        </form>
        <!-- End -->
  ...
  <!-- end search product -->
    ...
    <form method="post">
        ...
        <button type="submit" class="btn btn-primary">Search</button>
          ...
          <?php endforeach; ?>
    <?php else: ?>
      <h1 class="" style="text-align: center;">Sorry any product finded !</h1>
    <?php endif; ?>
    </div>
</div>
<hr>
